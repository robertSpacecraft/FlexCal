    ...
    <div className="card results-container">
      ...
      {isPredictive && (
        <div className="predictive-results">
          ...
          <div className="result-item highlight">
            <span className="label">Tiempo restante hasta 8h 30m:</span>
            <span className="value">{formatDuration(remainingToTarget)}</span>
          </div>
          
          <div className="result-item highlight-target">
            <span className="label">Hora para cumplir jornada (8h 30m):</span>
            <span className="value time-value">{minutesToTime(predictiveExitTarget)}</span>
          </div>
          
          <div className="result-item">
            <span className="label">Tiempo restante hasta límite (9h 30m):</span>
      ...
      {isFinal && (
        <div className="final-results">
          ...
          <div className="result-item">
            <span className="label">Saldo respecto a 8h 30m:</span>
          ...
          <div className="evaluation-box">
            {state === 'WITHIN_MARGIN' && (
              <div className={balance < 0 ? "status-deficit" : "status-success"}>
                ...
                <p>
                  {balance === 0 
                    ? "Has cumplido exactamente tu jornada de 8h 30m." 
                    : balance > 0 
            ...
            {state === 'EXCESS_POSITIVE' && (
              <div className="status-overtime">
                ...
                <p>Has superado el límite máximo de flexibilidad diaria (9h 30m).</p>
            ...
            {state === 'DEFECT_NEGATIVE' && (
              <div className="status-deficit">
                ...
                <p>No has cumplido el tiempo mínimo exigido diario (7h 30m).</p>
                <div className="action-required">
